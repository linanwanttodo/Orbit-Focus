...
|:---:|:---:|
| Главный интерфейс / Часы | Таймер концентрации |
...
|:---:|:---:|
| Панель данных кодирования | Тест скорости набора кода |
...
|:---:|
| Управление задачами / Список дел |
...
Вы можете скачать официальные установщики на странице [Releases](https://github.com/linanwanttodo/Orbit-Focus/releases). Следуйте инструкциям ниже для вашей платформы:

### Linux

| Формат пакета | Поддерживаемые системы | Установка / Использование |
| :--- | :--- | :--- |
...
| **.AppImage** | Универсальный Linux | `chmod +x "Orbit Focus-1.0.0.AppImage"` и запустите |

### Windows

1. Скачайте программу установки **Orbit-Focus-Setup-1.0.0.exe**.
2. Дважды щелкните, чтобы запустить мастер установки.
3. После установки запустите приложение с рабочего стола или из меню «Пуск».

### macOS

1. Скачайте образ диска **Orbit-Focus-1.0.0.dmg**.
2. Дважды щелкните, чтобы смонтировать образ, и перетащите **Orbit Focus** в папку **Applications**.
3. Запустите из папки программы. Если появится предупреждение безопасности, разрешите запуск в разделе «Системные настройки > Конфиденциальность и безопасность».
...
**Примечание по вторичной разработке**: Этот проект имеет открытый исходный код под лицензией MIT для обучения и обмена. Если вы планируете использовать этот проект для вторичной разработки или перераспределения, пожалуйста, укажите первоисточник. Открытый исходный код — это нелегкий труд, давайте уважать работу каждого разработчика.
